...
fn bench_str_under_8_bytes(b: &mut Bencher) {
    let s = "foo";
    b.bench_function("kh bench_str_under_8_bytes", |b| {
        b.iter(|| {
            hash(&s);
        })
    });
...
fn bench_str_of_8_bytes(b: &mut Bencher) {
    let s = "foobar78";
    b.bench_function("kh bench_str_of_8_bytes", |b| {
        b.iter(|| {
            hash(&s);
        })
    });
...
fn bench_str_over_8_bytes(b: &mut Bencher) {
    let s = "foobarbaz0";
    b.bench_function("kh bench_str_over_8_bytes", |b| {
        b.iter(|| {
            hash(&s);
        })
    });
...
fn bench_long_str(b: &mut Bencher) {
    ...
    b.bench_function("kh bench_long_str", |b| {
        b.iter(|| {
            hash(&s);
        })
    });
...
fn bench_bytes_7(b: &mut Bencher) {
    let u = black_box([b' '; 7]);
    b.bench_function("kh bench_bytes_7", |b| {
        b.iter(|| {
            hash(&u);
        })
    });
...
fn bench_bytes_8(b: &mut Bencher) {
    let u = black_box([b' '; 8]);
    b.bench_function("kh bench_bytes_8", |b| {
        b.iter(|| {
            hash(&u);
        })
    });
...
fn bench_bytes_a_16(b: &mut Bencher) {
    ...
    b.bench_function("kh bench_bytes_a_16", |b| {
        b.iter(|| {
            hash(&u);
        })
    });
...
fn bench_bytes_b_32(b: &mut Bencher) {
    ...
    b.bench_function("kh bench_bytes_b_32", |b| {
        b.iter(|| {
            hash(&u);
        })
    });
...
fn bench_bytes_c_128(b: &mut Bencher) {
    ...
    b.bench_function("kh bench_bytes_c_128", |b| {
        b.iter(|| {
            hash(&u);
        })
    });
